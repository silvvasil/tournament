...
from .tournament import compil, get_tournament, strategy_by_user, versus
...
def battle(request, first, second):
    ...
    versus("compiled_strategies/" + strategy_1, "compiled_strategies/" + strategy_2)
...
def upload(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            flag = compil(filename + ".cpp", "compiled_" + filename)
            if flag:
